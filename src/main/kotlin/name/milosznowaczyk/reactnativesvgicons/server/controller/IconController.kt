...
class IconController(
    ...
    @CrossOrigin(origins = arrayOf("http://localhost:3000/", "https://api.react-native-svg-icons.xn--miosznowaczyk-xhc.name/", "https://react-native-svg-icons.xn--miosznowaczyk-xhc.name/"))
    @GetMapping
    fun getIcons(
